...
import static com.example.schoolcircle.ui.RegActivity.getContainChinese;

public class MangerRegAct extends BaseActivity implements View.OnClickListener {
...
//                break;
    ...
    private void submit() {
        ...
        if (TextUtils.isEmpty(stuacc)) {
            Toast.makeText(this, "请输入工号号", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        mainQuery.findObjects(this, new FindListener<User>() {
            ...
            public void onSuccess(List<User> list) {
                ...
                if (list.size()==0){
                    ...
                    Toast.makeText(MangerRegAct.this, "账号或工号或姓名已存在"+list.size(), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onError(int i, String s) {
                Toast.makeText(MangerRegAct.this, "服务器异常稍后再试", Toast.LENGTH_SHORT).show();
            }
        });
