...
public class MyFsinfo extends BaseActivity {
...
//                mai.setVisibility(View.VISIBLE);
                ...
                if (!TextUtils.isEmpty(circleBean.head)){
                    Glide.with(MyFsinfo.this).load(circleBean.head).into(view);
                }
                ...
                if (!TextUtils.isEmpty(circleBean.imgs)){
                    ...
                    recyclerView.setLayoutManager(new GridLayoutManager(MyFsinfo.this,3));
                    SimpleAdapter    aaa = new SimpleAdapter<>(R.layout.item_photo, pahtList, new SimpleAdapter.ConVert<String>() {
                        ...
                        public void convert(BaseViewHolder helper, final String path) {
                            ...
                            Glide.with(MyFsinfo.this).load(path).into(view);
...
//    }
    ...
    private void getuserinfo() {
        ...
        bmobQuery.addWhereEqualTo("account", gzinfo.account);
        ...
        bmobQuery.findObjects(this, new FindListener<User>() {
            ...
            public void onSuccess(List<User> list) {
                ...
                if (user.img != null) {
                    Glide.with(MyFsinfo.this).load(user.img.getUrl()).into(ivHead);
                }
            }

            @Override
            public void onError(int i, String s) {
                Toast.makeText(MyFsinfo.this, "服务器异常稍后再试", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getRealFenSiNum(){
        BmobQuery<GuanZhu> bmobQuery=new BmobQuery<>();
        bmobQuery.addWhereEqualTo("u_id",gzinfo.account);
        bmobQuery.findObjects(this, new FindListener<GuanZhu>() {
            @Override
            public void onSuccess(List<GuanZhu> list) {
...
//                Toast.makeText(MyFsinfo.this, list.size()+"成功", Toast.LENGTH_SHORT).show();
            }
