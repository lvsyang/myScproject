...
public class UserMangerAct extends BaseActivity {
    ...
    public void initView() {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                jumpAct(UserDetialAct.class,bundle);
            }
        });
    ...
    private void getadData() {
        ...
        bmobQuery.addWhereNotEqualTo("userlimit",limit0);//超级管理员可以管理管理员
        ...
        bmobQuery.findObjects(this, new FindListener<User>() {
            ...
            public void onError(int i, String s) {
                Toast.makeText(UserMangerAct.this, "服务器异常稍后再试", Toast.LENGTH_SHORT).show();
            }
        });
    }
